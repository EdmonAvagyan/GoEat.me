...
class MainPage: UIViewController {
    ...
    var food = ["Barbecue", "Pizza", "Sandwich", "Lahmacun", "Shaurma", "Salad", "Juice", "Fresh"]
...
extension MainPage: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.setupData(item: foodData[indexPath.row])
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        //let caterories: [[String]] = [barbecue, pizza, sandwich, lahmajo, shaurma, salad, juice, fresh]
